...
WELCOMES_MESSAGE_M = "Welcome to your motivation channel. You need motivation ? Just write 'Motivation needed' and I will help to motivate you.This channel is a platform for mutual exchange and also to increase each other's motivation. So get started and share your situation. "
#WILLKOMMENSNACHRICHT_PS = "Welcome to your problem solver. You can't find a solution to your problem ? talk to others and find the right solution to your problem. You can also be a help to others and support them with their problem."
...
def read_messages():
    global CHANNEL_FILE, WELCOMES_MESSAGE_M, MAX_MESSAGES
    try:
    ...
    # check if welcome message exsists 
    if not any(msg['content'] == WELCOMES_MESSAGE_M for msg in messages):
        messages.insert(0, {
            'content': WELCOMES_MESSAGE_M,
